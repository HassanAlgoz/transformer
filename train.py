...
def train(*,
    ...
    for i in t:
        ...
        if i % params.save_summary_steps == 0:
            ...
            summary = {metric: metrics[metric](output, expected_output)
...
if __name__ == '__main__':
    ...
    embeddings_kv = KeyedVectors.load_word2vec_format('./data/embeddings/glove.6B.100d.txt', binary=False, no_header=True)
    ...
    val_data_loader = DataLoader(val_dataset, batch_size=params.batch_size, shuffle=True)
    ...
    train_and_evaluate(model, train_data_loader, val_data_loader, optimizer, loss_fn, metrics,
